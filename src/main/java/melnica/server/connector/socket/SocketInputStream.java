...
public class SocketInputStream extends InputStream {
	 ...
	 * @throws java.io.IOException If an exception occurs during the underlying
	 *                             socket read operations, or if the given buffer is
	 *                             not big enough to accomodate the whole line.
	 */
